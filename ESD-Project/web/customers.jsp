<%-- 
    Document   : customers
    Created on : 10-Nov-2018, 20:49:40
    Author     : jonasarud
--%>
...
<%
    ...
    <div id="tbl-header">
            ...
            <div id="tbl-content">
                ...
                <td><a class="button" href='delete.jsp?d=<%=resultSet.getString("customerID") %>&j=<%=resultSet.getString("email")%>' role="button">Delete Customer</a></td>
                </tr>
                </table>
            </div>
            <% 
